...
const SXNetworkCardContent: React.FC = () => {
  ...
  const enableWSXHook = () => {
    dispatch(
      approveWSX({ amount: 100000000000000, addressToApprove: address.cwSX }),
    );
  ...
  function Content({ isSupply }: { isSupply: boolean }) {
    if (isSupply)
        ...
        <div>
          ...
          <Space direction="vertical" style={{ width: "100%" }}>
            <InputNumber
              ...
              prefix={
                <img width="20" height="20" src={sxtoken} alt="WSX Token" />
              }
              placeholder="Enter an amount"
              controls={false}
            />
            <Button type="primary" size="large" onClick={depositWSXHook}>
              Deposit
            </Button>
          </Space>
      ...
      return (
        <div>
          <p>
            To supply, withdraw, or repay your Wrapped SX, you need to enable it
            first
          </p>
          <Space direction="vertical" style={{ width: "100%" }}>
            <InputNumber
              ...
              size="large"
              onChange={(value) => {
                withdrawAmount = value! as number;
              }}
              prefix={
                <img width="20" height="20" src={sxtoken} alt="WSX Token" />
              }
              ...
              controls={false}
            />
            <Button type="primary" size="large" onClick={withdrawWSXHook}>
              Withdraw
            </Button>
          </Space>
        </div>
