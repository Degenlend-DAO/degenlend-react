...
"cERC20": '0xbdC2A1a7239fac713EBF5dAb69931b37FE4c9B9A', 'testnetSX': '0x2D4e10Ee64CCF407C7F765B363348f7F62D2E06e', // use gas balance
"testnetUSDC": '0x5147891461a7C81075950f8eE6384e019e39ab98', "comptroller": '', "JumpRateModelV2": '0xd26cCEdaCb5E1166e3285ba5EF9817f45F6bfA76', "account": '0x4869aF0Aed0a9948f724f809dC0DCcF9885cCe34',
}
...
//WSX
export const wSX = new Contract(address.testnetSX, erc20ABI, provider);

// cWSX
export  const cWSX = new Contract(address.cERC20, cerc20ABI, provider);
// cUSDC
export  const cUSDC = new Contract(address.account, cerc20ABI, provider);